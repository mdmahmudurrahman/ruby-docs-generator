...
ActiveRecord::Schema.define(version: 20_161_118_100_718) do
  ...
  create_table 'labs', force: :cascade do |t|
    ...
    t.datetime 'created_at',  null: false
    t.datetime 'updated_at',  null: false
    t.index ['document_id'], name: 'index_labs_on_document_id', using: :btree
  end
  ...
  create_table 'practices', force: :cascade do |t|
    ...
    t.datetime 'created_at',  null: false
    t.datetime 'updated_at',  null: false
    t.index ['document_id'], name: 'index_practices_on_document_id', using: :btree
  end
  ...
  add_foreign_key 'labs', 'documents'
  add_foreign_key 'main_modules', 'documents'
  add_foreign_key 'practices', 'documents'
